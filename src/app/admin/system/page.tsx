        ...
        {[
          {
            ...
            detail: process.env.NEXT_PUBLIC_FRONTEND_URL ?? 'https://aitradinglab.cloud',
          },
          {
            ...
            <div className="ml-6 space-y-1 text-xs text-zinc-500">
              {errorMsg?.includes('not configured') ? (
                <p>
                  ...
                  <br/>
                  <code className="text-emerald-400">AI_ENGINE_URL = http://ai-engine:8000</code>
                </p>
              ) : (
                <p>
                  O serviço AI Engine pode estar a dormir.
      ...
      <Card className="bg-zinc-900/50 border-zinc-800">
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <EnvRow label="Vault USDC Address"    envKey="NEXT_PUBLIC_VAULT_USDC_ADDRESS"    value={process.env.NEXT_PUBLIC_VAULT_USDC_ADDRESS}    required />
            <EnvRow label="Vault USDT Address"    envKey="NEXT_PUBLIC_VAULT_USDT_ADDRESS"    value={process.env.NEXT_PUBLIC_VAULT_USDT_ADDRESS}    required />
          ...
          <div>
            ...
            <div className="p-3 rounded-lg bg-zinc-800/50 border border-zinc-700/50 space-y-1">
              {[
                ...
                { k: 'USDC Vault', v: process.env.NEXT_PUBLIC_VAULT_USDC_ADDRESS },
                { k: 'USDT Vault', v: process.env.NEXT_PUBLIC_VAULT_USDT_ADDRESS },
      ...
      <Card className="bg-zinc-900/50 border-zinc-800">
        ...
        <CardContent>
          <div className="space-y-2">
            {[
              { label: 'USDC Vault (Arbitrum One)', value: process.env.NEXT_PUBLIC_VAULT_USDC_ADDRESS ?? '0x876aBa48F1263Ffb16046Ef2909265BeDCb3174C' },
              { label: 'USDT Vault (Arbitrum One)', value: process.env.NEXT_PUBLIC_VAULT_USDT_ADDRESS ?? '0x12a20d3569da6DD2d99E7bC95748283B10729c4C' },
              { label: 'USDC Arbitrum One',        value: '0xaf88d065e77c8cC2239327C5EDb3A432268e5831' },
              { label: 'USDT Arbitrum One',        value: '0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9' },
              { label: 'WETH Arbitrum',            value: '0x82aF49447D8a07e3bd95BD0d56f35241523fBab1' },
              { label: 'ETH/USDC Pool (Arbitrum One)',  value: '0xC6962004f452bE9203591991D15f6b388e09E8D0' },
